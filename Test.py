...
# 1. Verifica que las direcciones han sido agregadas correctamente
...
# 2. Verifica que la tarifa comfort ha sido seleccionada
    def test_select_comfort(self):
        routes_page = UrbanRoutesPage(self.driver)
        routes_page.select_ride_comfort()
        assert routes_page.active_comfort() == True

    # 3.Verifica que el número de teléfono aparezca en el campo correctamente
    ...
    def test_add_card(self):
        ...
        assert routes_page.correct_text_add_card() == "Tarjeta"  #CAMBIO SUGERIDO 
    ...
    # 9. Verifica que la ventana con la información del conductor aparezca
